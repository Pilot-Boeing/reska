...
function migrate() {
  ...
  db.exec(`
    ...
    CREATE INDEX IF NOT EXISTS idx_call_history_from ON call_history(from_user, created_at);
    CREATE INDEX IF NOT EXISTS idx_call_history_to ON call_history(to_user, created_at);
  `);
