...
(function () {
  const P = {
    ...
    paperclip: '<path d="M20.5 11.4l-8.2 8.2a5 5 0 01-7.1-7.1l9.2-9.2a3.5 3.5 0 015 5l-9 9a2 2 0 01-2.9-2.9l8-8"/>',
    image: '<rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="9" cy="9" r="1.6"/><path d="M4 19l5-5 3 3 4-4 4 4"/>',
    round: '<circle cx="12" cy="12" r="9"/><path d="M10 8.5l6 3.5-6 3.5z" fill="currentColor" stroke="none"/>',
    download: '<path d="M12 3v11M8 10l4 4 4-4M5 19h14"/>',
    reply: '<path d="M9 14l-4-4 4-4M5 10h11a4 4 0 014 4v3"/>',
    forward: '<path d="M15 14l4-4-4-4M19 10H8a4 4 0 00-4 4v3"/>',
    bell_off: '<path d="M6 9a6 6 0 0112 0c0 4 1 5 2 6H4c.6-1 1-1.5 1.4-2.5M10 19a2 2 0 004 0M3 3l18 18"/>',
    check_all: '<path d="M3 11l3.5 3.5L13 8M9.5 16l2.5 2.5L18.5 7"/>',
